...
export default function StockFilter(props) {
  ...
  const [vOriginalNumber, setvOriginalNumber] = useState(
    props.filter.vOriginalNumber
  );
  ...
  const [sOriginalNumber, setsOriginalNumber] = useState(
    props.filter.sOriginalNumber
  );
